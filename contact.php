        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Lach Tray, Hai Phong, Vietnam</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>hieu92264@st.vimaru.edu.vn</p>
                    <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+012 345 67890</p>
                </div>
                <div class="d-flex flex-column">
                    <h5 class="font-weight-semi-bold mb-3">Store 2</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>100 Tran Phu, Hai Phong, Vietnam</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>hoang92603@st.vimaru.edu.vn</p>
                    <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+012 345 67890</p>
                </div>
            </div>
        </div>
